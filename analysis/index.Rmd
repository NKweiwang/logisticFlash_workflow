...
Click on this [All chr 22 sample 8000](All_chr22_8000.html) to see my result.

### HIV data

Click on this [HIV data(?)](HIVdata.html) to see my result.

## TSNE on the MNIST data

Click on this [small sample MNIST data](MNISTdata_1000.html) to see my result.

## Compound poisson process with logistic flash

Click on this [compound poisson + logistic flash](compoundpossiondocs.html) to see my result.

Click on this [question to Mengyin](compoundpoissonsimulation1.html) to see my result.
